...
//        myZoo.displayAnimals();
        ...
        Animal a2 = new Animal("Canidae", "Wolf", 3, true);
        Animal a3 = new Animal("Elephantidae", "Elephant", 10, true);
        Animal a4 = new Animal("Bird", "Eagle", -5, false);

        Animal[] list = {a1, a2, a3, a4};
        for (Animal a : list) {
            try {
                myZoo.addAnimal(a);
                System.out.println(a.getName() + " ajouté !");
            }
            ...
            System.out.println("Nombre d’animaux: " + myZoo.nbrAnimals);
        }
    }
